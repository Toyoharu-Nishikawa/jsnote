...
export const  expisen1 = (P, T) => {
  if(P<=0.0 || T<=0.0){
    throw new RangeError("function expisen1 P<=0 T<=0 in expisen.js")
  }
...
export const expisen2 = (P, T) => {
  if(P<=0.0 || T<=0.0){
    throw new RangeError("function expisen2 P<=0 T<=0 in expisen.js")
  }
...
export const expisen3h = (v, T) => {
  if(v<=0.0 || T<=0.0){
    throw new RangeError("function expisen3h v<=0 T<=0 in expisen.js")
  }
  const Tn  = 647.096
  const rhon= 322.0
  const R   = 0.461526
...
export const expisen5 = (P, T) => {
  ...
  if(P<=0.0||T<=0.0){
    throw new RangeError("function expisen5 P<=0 T<=0 in expisen.js")
  }
