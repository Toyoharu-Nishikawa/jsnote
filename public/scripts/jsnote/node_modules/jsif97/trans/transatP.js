...
export const transatP = (P) => {
  ...
  if(P <= 0.0){
    throw new RangeError("function transatP P<=0 in transatP.js");
  }
  const Ttmp1 = 273.15
  const Ptmp1 = PsatT(Ttmp1)
  if(P < Ptmp1){
    throw new RangeError("function transatP P<=min in transatP.js");
  }
  if(P > 22.064){
    throw new RangeError("function transatP P>22.064 in transatP.js");
  }
