...
export const dielsatP = (P) => {
  if(P <= 0){
    throw new RangeError("function dielsatp P<=0 in dielsatP.js")
  } 
  const Tmin = 273.15
  const Pmin = PsatT(Tmin)

  if(P < Pmin){
      throw new RangeError('function dielsatp P is lower than the minimum pressure in dielsatP.js.')
  }
  if(P > 22.064){
      throw new RangeError('function dielsatp P is lower than the maximum pressure in dielsatP.js.')
  } 
