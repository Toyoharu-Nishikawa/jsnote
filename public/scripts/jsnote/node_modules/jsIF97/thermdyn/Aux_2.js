...
export const ZPH_2 = (P, h) => {
  ...
  if(Flag==0){
    throw new RangeError("function ZPH_2 not converged in Aux_2.js");
    return -1;
  }  
  return state 
}
...
export const ZPS_2 = (P, s) => {
  ...
  if(P<=0.0 || T<=0.0){
    throw new RangeError("function ZPS_2 P<=0 T<=0 in Aux_2.js")
  }
  ...
  if(Flag==0){
    throw new RangeError("function ZPS_2 ZPS_2 not converged in Aux_2.js");
  }
